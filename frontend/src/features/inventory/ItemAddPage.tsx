...
export default function ItemAddPage() {
    ...
    async function handleSubmit(e: SubmitEvent<HTMLFormElement>) {
        ...
        const data = {"item": itemId, "purchased_on": purchasedOn, 
            "expiry_date": expiry,  "qty": qty, "unit": unit}

        try {
            await http.post(`/households/${householdid}/inventory`, data);
            navigate(`/households/${householdid}/inventory`, { replace: true});
        } catch {
            ...
            <Paper withBorder shadow="md" radius="xl" p="xl" maw={760} mx="auto">
                <Stack gap="lg">
                    <div>
                        ...
                        <Text c="dimmed">
                            Enter details to add item to inventory.
                        </Text>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <Stack gap="lg">
                            ...
                            <Stack gap="md" justify="flex-start" style={ { flexDirection: "row"}}>
                                ...
                                type="date"
                                value={purchasedOn}
                                onChange={(e) => setPurchasedOn(e.currentTarget.value)}
                                required
                                />
